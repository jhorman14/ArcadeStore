<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            <label for="nick" class="form-label">{{ __('Nick') }}</label>
            <input type="text" name="nick" class="form-control @error('nick') is-invalid @enderror" value="{{ old('nick', $user?->nick) }}" id="nick" placeholder="Nick">
            {!! $errors->first('nick', '<div class="invalid-feedback" role="alert"><strong>:message</strong></div>') !!}
        </div>
        <div class="form-group mb-2 mb20">
